...
By default, Terraform stores the state file locally on the machine where it is executed `local state`. This approach is simple and effective for individual use or small projects but can introduce risks in collaborative environments.
